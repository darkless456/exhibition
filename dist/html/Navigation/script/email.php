...
// // 检测输入
// if(isset($_POST['1'])){
//     $recipients = $_POST['recipients']; //收件人
...
//     } else{
//         $signature = $_POST['signature'].'<br/><div style="padding:10px 10px 0;border-top:1px solid #ccc;color:#999;margin-bottom:20px;line-height:1.3em;font-size:12px;"><p style="margin-bottom:15px; margin-right:auto; margin-left:auto;">极客导航邮件系统自动提醒,请不要回复<br /></p></div>';
//     }


//     // 发送邮件
//     $mail = new SendMail();
//     // $mail->setServer("smtp.qiye.163.com", "XXXXX@126.com", "XXXXX"); //设置smtp服务器，普通连接方式
...
//     if(isset($_POST['cc'])){
//         $cc = $_POST['cc'];
//         $mail->setCc($cc); //设置抄送，多个抄送，调用多次    
//     }
//     //是否有密送
//     if(isset($_POST['bcc'])){
//         $bcc = $_POST['bcc'];
//         $mail->setBcc($bcc); //设置秘密抄送，多个秘密抄送，调用多次
//     }
